...
impl QsonautGuiApp {
    ...
    pub(crate) fn new_with_context(
        ...
        Self {
            ...
            third_party_bridge,
            server_client,
            server_browser_link_rx: None,
            server_browser_link_stop: None,
            server_browser_link_url: None,
            server_browser_link_code: None,
            server_browser_link_status: String::new(),
