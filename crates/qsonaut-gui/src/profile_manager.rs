    ...
    pub(super) fn current_operator_profile(&self) -> OperatorProfile {
        ...
        OperatorProfile {
            ...
            radio: profile::RadioProfileSettings {
                ...
                hostbridge_access_key: self.config.radio.hostbridge_access_key.clone(),
                hostbridge_password: self.config.radio.hostbridge_password.clone(),
                hostbridge_radio_id: self.config.radio.hostbridge_radio_id.clone(),
                hostbridge_audio_source_id: self.config.radio.hostbridge_audio_source_id.clone(),
                hostbridge_audio_output_id: self.config.radio.hostbridge_audio_output_id.clone(),
            },
