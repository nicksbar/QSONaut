...
struct GuiState {
    ...
    cw_live_text: String,
    cw_character_count: usize,
    cw_envelope_rate: f32,
    cw_auto_target: bool,
...
impl Default for GuiState {
    fn default() -> Self {
        Self {
            ...
            cw_character_count: 0,
            cw_envelope_rate: 0.0,
...
struct QsonautGuiApp {
    ...
    cw_wpm: u8,
    cw_tone_hz: u16,
    cw_qso_callsign: String,
    cw_qso_rst_sent: String,
    cw_qso_rst_received: String,
    cw_qso_exchange_received: String,
    cw_qso_notes: String,
    cw_qso_started_at: Option<u64>,
    recording_enabled: bool,
