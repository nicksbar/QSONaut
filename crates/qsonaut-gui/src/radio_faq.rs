...
fn model_docs_for(model: &str) -> (&'static str, &'static str) {
    ...
    choose!(
        ...
        "IC-7610" => "ic-7610", "IC-9700" => "ic-9700", "IC-756PRO" => "ci-v-generic",
        "IC-756PROII" => "ci-v-generic", "IC-756PROIII" => "ci-v-generic",
        "classic CAT (generic)" => "yaesu-classic-generic", "FT-817ND" => "ft-817nd",
        "FT-1000" => "yaesu-classic-generic", "FT-1000D" => "yaesu-classic-generic",
        "FT-818" => "ft-818", "FT-857D" => "ft-857d", "FT-897D" => "ft-897d",
