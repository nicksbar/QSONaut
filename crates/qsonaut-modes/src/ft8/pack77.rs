...
fn encode_grid4(grid: &str) -> Option<u32> {
    ...
    if lat_major > 17 || lon_major > 17 || lat_minor > 9 || lon_minor > 9 {
        return None;
    }
...
pub fn pack77(msg: &Ft8Message) -> Option<[u8; 77]> {
    ...
    match msg {
        ...
        Ft8Message::Standard {
            ...
            let i3: u32 = if ipa == 1 && call1.ends_with("/P") {
                2
            } else {
                1
            };
            ...
            let ig = encode_grid4(report).or_else(|| encode_report(report))?;
