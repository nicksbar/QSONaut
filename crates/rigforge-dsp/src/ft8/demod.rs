...
use rigforge_modes::ft8::params::{SAMPLES_PER_SYM, SAMPLE_RATE, N, N_SYM};
...
pub fn extract_symbol_magnitudes(
    samples: &[f32],
    f0_hz: f32,
    t0_s: f32,
) -> [[f32; 8]; N_SYM] {
...
pub fn demodulate(samples: &[f32], f0_hz: f32, t0_s: f32) -> [f32; N] {
    use rigforge_modes::ft8::decode::symbol_magnitudes_to_llr;
...
mod tests {
    use super::*;
    use rigforge_modes::ft8::{encode::message_to_tones, pack77::Ft8Message};
    use rigforge_modes::ft8::decode::decode_llr;
