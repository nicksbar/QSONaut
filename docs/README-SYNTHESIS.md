...
├── qsonaut-ai (placeholder AI features)
├── qsonaut-audio (cpal 0.15 - audio I/O)
├── qsonaut-core (config + event bus)
├── qsonaut-dsp (rustfft 6 - signal processing)
├── qsonaut-gui (eframe GUI with FT8/FT4 mode workflows)
├── qsonaut-log (ADIF import/export)
├── qsonaut-modes (FT8/FT4/FST4/JT9/JT65/Q65/WSPR/MSK144)
